...
– **Локализация изменений.** Замена платёжного провайдера (например, переход с *PayPal* на Ю*Kassa*) затрагивает только реализацию контекста; экраны и компоненты не меняются.
...
Условия труда разработчика программного обеспечения на территории Приднестровской Молдавской Республики регулируются следующими нормативными правовыми актами:

– Трудовой кодекс Приднестровской Молдавской Республики (Закон ПМР от 19 июля 2002 года № 161-З-III, в действующей редакции), раздел X «Охрана труда».
– Закон Приднестровской Молдавской Республики «Об охране и безопасности труда» (от 23 ноября 1994 года № 22-З, в действующей редакции).
– Закон Приднестровской Молдавской Республики «О санитарно-эпидемиологическом благополучии населения» (от 3 июня 2008 года № 481-З-IV).
– СанПиН ПМР 2.2.2/2.4.1340-03 «Гигиенические требования к персональным электронно-вычислительным машинам и организации работы».
– ГОСТ 12.2.032-78 «ССБТ. Рабочее место при выполнении работ сидя. Общие эргономические требования» – действует на территории ПМР как унаследованный межгосударственный стандарт.
...
– **Площадь рабочего места** – не менее 4,5 м² на одного работника при использовании ВДТ с ЖК-экраном и не менее 6,0 м² при использовании ВДТ на основе ЭЛТ (по требованиям СанПиН ПМР 2.2.2/2.4.1340-03).

### 3.7.3 Режим труда и отдыха

В соответствии с СанПиН ПМР 2.2.2/2.4.1340-03:
