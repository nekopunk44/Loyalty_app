...
9. **Выполнена экономическая оценка** — общая трудоёмкость продакшен-версии составляет 8944 человеко-часа, прямые затраты на разработку — около 10,1 млн руб. ПМР; ожидаемый период окупаемости при консервативной оценке прироста выручки на 10 % — 27–34 месяца, что укладывается в стандартный для гостиничной индустрии диапазон.
